...
class PurchaseOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase_order" do
    assert_difference('PurchaseOrder.count') do
      post purchase_orders_url, params: { purchase_order: { client: @purchase_order.client, latitude: @purchase_order.latitude, longitude: @purchase_order.longitude, products: @purchase_order.products, proveedor: @purchase_order.proveedor, total: @purchase_order.total } }
    end
  ...
  test "should update purchase_order" do
    patch purchase_order_url(@purchase_order), params: { purchase_order: { client: @purchase_order.client, latitude: @purchase_order.latitude, longitude: @purchase_order.longitude, products: @purchase_order.products, proveedor: @purchase_order.proveedor, total: @purchase_order.total } }
